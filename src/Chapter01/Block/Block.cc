...
// DEPRECATED
// #define MEDIA_PATH #MEDIA_PATH_INPUT
...
void SetupRC()
	...
	// Wood floor
	ss.clear(), ss.str("");
	ss<<MEDIA_PATH<<"/floor.tga";
    pBytes = gltReadTGABits((ss.str().c_str()), &nWidth, &nHeight, &nComponents, &format);
...
{
	// DEBUG
	std::cout<<"MEDIA_PATH = "<<MEDIA_PATH<<std::endl;
