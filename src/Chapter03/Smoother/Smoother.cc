...
GLBatch             smallStarBatch;         // 小星星
GLBatch             mediumStarBatch;        // 中等星星
GLBatch             largeStarBatch;         // 大号星星
GLBatch             mountainRangeBatch;     // 山峦
GLBatch             moonBatch;              // 月亮
