...
GLBatch	squareBatch;		// 中间的活动方块
GLBatch greenBatch;			// 绿色的固定方块
GLBatch redBatch;			// 红色的固定方块
GLBatch blueBatch;			// 蓝色的固定方块
GLBatch blackBatch;			// 黑色的固定方块
...
void SpecialKeys(int key, int x, int y)
{
	...
	GLfloat blockX = vVerts[0];   // Upper left X -- 应该是 Bottom left X 吧?
	...
	// Recalculate vertex positions -- 方块位置的更新和计算
	vVerts[0] = blockX;
